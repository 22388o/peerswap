...
State_SwapInReceiver_AwaitTxConfirmation --> State_SwapInReceiver_BuildSigHash: Event_OnCancelReceived
State_SwapInReceiver_ValidateTxAndPayClaimInvoice
State_SwapInReceiver_ValidateTxAndPayClaimInvoice --> State_SwapInReceiver_BuildSigHash: Event_ActionFailed
...
State_SwapInReceiver_BuildSigHash --> State_SwapInReceiver_SendCoopClose: Event_ActionSucceeded
State_SwapInReceiver_BuildSigHash --> State_SendCancel: Event_ActionFailed
State_SwapCanceled
```